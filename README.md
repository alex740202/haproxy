...
2. Установлен и настроен HAProxy.[haproxy.cfg](haproxy.cfg)
...
2. Настройте балансировку Weighted Round Robin на 7 уровне, чтобы первый сервер имел вес 2, второй - 3, а третий - 4. [haproxy_2.cfg](haproxy_2.cfg)
